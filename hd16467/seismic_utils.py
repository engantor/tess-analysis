"""
Shared utilities for HD 16467 asteroseismic analysis.

Harvey background model, empirically-calibrated PSD, and lightcurve
loading. Imported by hd16467_seismic.py, split_half_validation.py,
and detection_summary.py.
"""
...
# Scaling-relation predictions for HD 16467 (K0III, Gaia log g=2.551, Teff=4966 K)
PRED_NMAX    = 43.3   # µHz
PRED_DELTANU = 4.8    # µHz
...
# ── Lightcurve loading ──────────────────────────────────────────────────────
def load_sectors_ppm(identifier="HD 16467", author="SPOC", sector_filter=None,
                     verbose=True):
    """
    ...
    with warnings.catch_warnings():
        ...
        search = lk.search_lightcurve(identifier, mission="TESS", author=author)
...
def fit_harvey_model(freq_uhz, psd, C_noise=None, nu_pred=PRED_NMAX,
    ...
    bounds_lo = [1,    5000,  1,   100,   0,    5,  1,   0.1]
    bounds_hi = [3000, 5e6, 1000, 5e5, 5e7,  150, 50, 5000]
